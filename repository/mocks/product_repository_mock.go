...
func (m *MockProductRepository) FindByCategory(ctx context.Context, categoryId uint64) ([]domain.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByCategory", ctx, categoryId)
	ret0, _ := ret[0].([]domain.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductRepositoryMockRecorder) FindByCategory(ctx, categoryId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByCategory", reflect.TypeOf((*MockProductRepository)(nil).FindByCategory), ctx, categoryId)
}
